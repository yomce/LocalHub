...
<template>
  <section class="board-page">
    <div class="page-heading"><div><p class="eyebrow">SEOUL COMMUNITY</p><h1>서울 지역 게시판</h1><p class="page-description">로그인 없이 여행 경험과 지역 정보를 공유해 보세요.</p></div><RouterLink class="primary-link" to="/board/new">글쓰기</RouterLink></div>
    ...
    <button class="text-button" type="button" @click="refreshPosts">게시글 새로고침</button>
  </section>
</template>
